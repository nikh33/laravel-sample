	...
	({
		...
		{	
			...
			({
					 ...
					 calendar.eventEnd = eEnd;
					  ...
					  $(opt.modalViewSelector).modal('show');
						...
						$(".modal-footer").delegate('[data-option="edit"]', 'click', function(e) 
						{
							...
							if(calendar.url === 'undefined') {
								$(".modal-header").html('<form id="event_title_e"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><label>'+opt.titleText+' </label>'+'<input type="text" class="input-block-level" name="title_update" value="'+calendar.title+'"></form>');
								$(".modal-body").html('<form id="event_description_e"><label>'+opt.descriptionText+' </label>'+'<textarea class="input-block-level" name="description_update">'+unescape(calendar.description)+'</textarea></form>');
							} else {
								$(".modal-header").html('<form id="event_title_e"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><label>'+opt.titleText+' </label>'+'<input type="text" class="input-block-level" name="title_update" value="'+calendar.title+'"></form>');
								$(".modal-body").html('<form id="event_description_e"><label>'+opt.descriptionText+' </label>'+'<textarea class="input-block-level" name="description_update">'+unescape(calendar.description)+'</textarea><label>Url: </label>'+'<input type="text" class="input-block-level" name="url_update" value="'+calendar.url+'"></form>');	
							}
				...
				{
					$(".modal-header").html('<form id="event_title"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><label>'+opt.titleText+' </label>'+'<input type="text" class="input-block-level" name="title" value=""></form>');
					
					$(".modal-body").html('<form id="event_description"><label>'+opt.descriptionText+' </label>'+'<textarea class="input-block-level" name="description"></textarea>'+opt.quickSaveCategory+'</form>');
